...
/datum/computer_file/report/recipient/nt/incident/xeno/generate_fields()
	add_field(/datum/report_field/instruction, "If non-human employee lacks a valid authorization, use form NEV-3213A instead.")
	..()
...
/datum/computer_file/report/recipient/nt/incident/xeno_no_visa/generate_fields()
	add_field(/datum/report_field/instruction, "If non-human has a valid authorization, use form NEV-3213 instead.")
	..()
	add_field(/datum/report_field/people/list_from_manifest, "Non-Human(s) Involved")
	add_signatures()
...
/datum/computer_file/report/recipient/nt/incident/synth
	form_name = "NEV-3213X"
	title = "NEV Northern Light Synthetic Incident Report"
	available_on_ntnet = 1
