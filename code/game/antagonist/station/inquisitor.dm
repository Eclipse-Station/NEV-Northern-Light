...
/datum/antagonist/inquisitor/greet()
	...
	to_chat(player, "The Inquisitors are Mekhane’s chosen agents, selected from the ranks of the faithful by Mekhane himself to expand the church’s interests and protect its followers.<br>\
	You are here to not only accomplish your assigned objectives, but also root out spies, saboteurs, and  \
	criminals within the church’s ranks. Interrogate Children of Mekhane followers, and deal with those who \
	would tarnish the public image of the church, or betray its principles.<br>\
	<br>\
	Any local church staff are your subordinates, and should obey your commands. With other disciples, \
	things are less clear. People may put their shipboard duties above their loyalty to the church. You should be discreet with the ship’s command staff, \
	revealing your role may tarnish the church’s reputation. It is often best to deal with internal problems quietly.<br>")

	if (was_priest)
		to_chat(player, "If you were the ship's preacher before, you have the authority to promote someone to be your replacement.")
	else
		to_chat(player, "The Mekhanite Council has called you to action. You may wish to make your presence known to the local preacher, if there is one.")
