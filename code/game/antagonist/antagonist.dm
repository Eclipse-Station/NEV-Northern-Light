/datum/antagonist
	...
	// Strings.
	var/welcome_text = "The Syndicate has been a thorn in the collected sides of every megacorp in the Galaxy, a band of highly organized criminals who cause havoc and chaos across the stars.<br>\
	...
	Use your code phrases and responses to find other operatives, and work to complete as many contracts as you can. Your uplink can be used to teleport a number of useful and dangerous items to help you. But be careful, the more overtly you act, the more quickly the crew will move against you. \
