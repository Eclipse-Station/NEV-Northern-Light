...
/obj/item/card/emag
	...
	description_antag = "This item has 10 uses by default. Emagging turrets turns them lethal to everyone. Emagging a door opens it and bolts it. Emagging a non-sentient robot turns them hostile. Emagging a cyborg forces them to obey you. Emagging an APC lets only you acces it." //Eclipse Edit - clarified language
	icon_state = "emag"
	item_state = "card-id"
	origin_tech = list(TECH_MAGNET = 2, TECH_COVERT = 2)
	var/uses = 10
