/obj/item/tool/omnitool
	name = "\"Munchkin 5000\""
	desc = "A Fuel-powered monster of a tool. Its weldier part is most advanced one, capable of welding things without harmfull glow and sparks, so no protection needed."
	icon_state = "omnitool"
