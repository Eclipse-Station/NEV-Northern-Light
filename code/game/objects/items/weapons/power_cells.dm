...
/obj/item/weapon/cell/large/moebius
	name = "NanoTrasen \"Power-Geyser 2000L\""
	desc = "NanoTrasen Laboratories branded rechargeable L-standardized power cell. This one is cheap, yet better than Aster model for same price."
	icon_state = "meb_b_st"
	maxcharge = 2000
...
/obj/item/weapon/cell/large/moebius/super
	name = "NanoTrasen \"Power-Geyser 13000L\""
	desc = "NanoTrasen Laboratories branded rechargeable L-standardized power cell. This advanced version can store even more energy."
	icon_state = "meb_b_sup"
	origin_tech = list(TECH_POWER = 5)
	maxcharge = 13000

/obj/item/weapon/cell/large/moebius/hyper
	name = "NanoTrasen \"Power-Geyser 18000L\""
	desc = "NanoTrasen Laboratories branded rechargeable L-standardized power cell. Looks like this is rare and powerful prototype."
	icon_state = "meb_b_hy"
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 18000

/obj/item/weapon/cell/large/moebius/nuclear
	name = "NanoTrasen \"Atomcell 13000L\""
	desc = "NanoTrasen Laboratories branded rechargeable L-standardized power cell. This version able to recharge itself over time."
	icon_state = "meb_b_nu"
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
...
/obj/item/weapon/cell/medium/moebius
	name = "NanoTrasen \"Power-Geyser 700M\""
	desc = "NanoTrasen Laboratories branded rechargeable M-standardized power cell. This one is cheap, yet better than Aster model for same price."
	icon_state = "meb_m_st"
	maxcharge = 700

/obj/item/weapon/cell/medium/moebius/high
	name = "NanoTrasen \"Power-Geyser 900M\""
	desc = "NanoTrasen Laboratories branded rechargeable M-standardized power cell. Popular and reliable version."
	icon_state = "meb_m_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 900

/obj/item/weapon/cell/medium/moebius/super
	name = "NanoTrasen \"Power-Geyser 1000M\""
	desc = "NanoTrasen Laboratories branded rechargeable M-standardized power cell. This advanced version can store even more energy."
	icon_state = "meb_m_sup"
	origin_tech = list(TECH_POWER = 5)
	maxcharge = 1000

/obj/item/weapon/cell/medium/moebius/hyper
	name = "NanoTrasen \"Power-Geyser 1300M\""
	desc = "NanoTrasen Laboratories branded rechargeable M-standardized power cell. Looks like this is rare and powerful prototype."
	icon_state = "meb_m_hy"
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 1300

/obj/item/weapon/cell/medium/moebius/nuclear
	name = "NanoTrasen \"Atomcell 1000M\""
	desc = "NanoTrasen Laboratories branded rechargeable M-standardized power cell. This version able to recharge itself over time."
	icon_state = "meb_m_nu"
	autorecharging = TRUE
...
/obj/item/weapon/cell/small/moebius/high
	name = "NanoTrasen \"Power-Geyser 250S\""
	desc = "NanoTrasen Laboratories branded rechargeable S-standardized power cell. Popular and reliable version."
	icon_state = "meb_s_hi"
	origin_tech = list(TECH_POWER = 2)
	maxcharge = 250

/obj/item/weapon/cell/small/moebius/super
	name = "NanoTrasen \"Power-Geyser 300S\""
	desc = "NanoTrasen Laboratories branded rechargeable S-standardized power cell. This advanced version can store even more energy."
	icon_state = "meb_s_sup"
	origin_tech = list(TECH_POWER = 5)
	maxcharge = 300

/obj/item/weapon/cell/small/moebius/hyper
	name = "NanoTrasen \"Power-Geyser 400S\""
	desc = "NanoTrasen Laboratories branded rechargeable S-standardized power cell. Looks like this is rare and powerful prototype."
	icon_state = "meb_s_hy"
	origin_tech = list(TECH_POWER = 6)
	maxcharge = 400

/obj/item/weapon/cell/small/moebius/nuclear
	name = "NanoTrasen \"Atomcell 300S\""
	desc = "NanoTrasen Laboratories branded rechargeable S-standardized microreactor cell. Recharges itself over time."
	icon_state = "meb_s_nu"
	autorecharging = TRUE
	origin_tech = list(TECH_POWER = 6)
...
/obj/item/weapon/cell/small/moebius/pda
	name = "NanoTrasen \"Atomcell 50S\""
	desc = "NanoTrasen Laboratories branded S-standardized microreactor cell. Recharges itself over time."
	icon_state = "meb_pda"
