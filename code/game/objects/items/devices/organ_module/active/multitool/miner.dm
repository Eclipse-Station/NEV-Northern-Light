/obj/item/organ_module/active/multitool/miner
	...
	desc = "A specialized mining multitool frequently purchased by the Union, it allows a miner to free up the space taken by some of their bulkier equipment. Includes an emergency radio, just in case."
