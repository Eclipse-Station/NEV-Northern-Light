...
/mob/proc/scorestats()
	...
	<b>Final Lazarus score:</b> [get_color_score(GLOB.moebius_score, GLOB.moebius_score)] Points<br><br>
	"}
	...
	<b>Final Engineering score:</b> [get_color_score(GLOB.technomancer_score, GLOB.technomancer_score)] Points<br><br>
	"}
