...
/datum/game_mode/malfunction/verb/elite_encryption_hack()
	...
	set desc = "200 CPU - Allows you to hack ship's ALERTCON system, changing alert level. Has high chance of failing."
	var/price = 200
	var/mob/living/silicon/ai/user = usr
	if(!ability_prechecks(user, price))
		return
...
/datum/game_mode/malfunction/verb/system_override()
	...
	set desc = "500 CPU - Begins hacking ship's primary firewall, quickly overtaking remaining APC systems. When completed grants access to ship's self-destruct mechanism. Network administrators will probably notice this."
	var/price = 500
	var/mob/living/silicon/ai/user = usr
