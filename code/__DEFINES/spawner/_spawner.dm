...
#define SPAWN_TAG_DICE				MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, "dice")
...
#define SPAWN_TAG_TOOL_ADVANCED		MERGE_SPAWN_TAGS(SPAWN_TAG_TOOL, "tool_advanced")
#define SPAWN_TAG_OS_TOOL			MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_TOOL, SPAWN_OS_TOOL), SPAWN_ONESTAR)
...
#define SPAWN_TAG_SWORD MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_WEAPON), SPAWN_KNIFE), SPAWN_SWORD)
#define SPAWN_TAG_KNIFE_CONTRABAND MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_WEAPON), SPAWN_KNIFE), SPAWN_CONTRABAND)
...
#define SPAWN_TAG_TOOL_UPGRADE MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_TOOL_UPGRADE)
#define SPAWN_TAG_TOOL_UPGRADE_RARE MERGE_SPAWN_TAGS(SPAWN_TAG_TOOL_UPGRADE, SPAWN_TOOL_UPGRADE_RARE)
#define SPAWN_TAG_TOOL_UPGRADE_RARE_OS MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_TOOL_UPGRADE_RARE, SPAWN_ITEM_TECH_OS), SPAWN_ONESTAR)
#define SPAWN_TAG_GUN_UPGRADE MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_GUN_UPGRADE), SPAWN_GUNS)

//items - one star
#define SPAWN_ITEM_TECH_OS "item_tech_os"

#define SPAWN_TAG_ITEM_TECH_OS MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_ITEM_TECH_OS), SPAWN_ONESTAR)
...
#define SPAWN_TAG_ORGAN MERGE_SPAWN_TAGS(SPAWN_TAG_ORGANS, "organ_organic")
...
#define SPAWN_TAG_PROSTHETIC_OS MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_PROSTHETIC, SPAWN_PROSTHETIC_OS), SPAWN_ITEM_TECH_OS), SPAWN_ONESTAR)
...
#define SPAWN_TAG_ELECTRONICS_TAG_JUNK MERGE_SPAWN_TAGS(MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_ELECTRONICS), SPAWN_JUNK)
