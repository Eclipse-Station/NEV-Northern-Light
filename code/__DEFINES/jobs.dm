...
#define JOBS_SECURITY "Chief of Security","Warden","Security Inspector","Brig Physician","Security Guard"
#define JOBS_COMMAND "Captain","Head of Personnel","Chief of Security","Supply Manager","Chief Engineer","Chief Medical Officer","Chief Science Officer","Lazarus Representive"
