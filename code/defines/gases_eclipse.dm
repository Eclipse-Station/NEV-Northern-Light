...
/decl/xgm_gas/trichloramine
	...
	flags = XGM_GAS_FUEL		//probably also a contaminant, but I'm just gonna make this gas only hazardous to breathe, not hazardous to wear.

//This gas is functionally identical to trichloramine, but is not flammable.
/decl/xgm_gas/chloramine
	id = "monochloramine"
	name = "Monochloramine"		//Technically this includes trichloramine
