...
/decl/hierarchy/outfit/job/medical/paramedic
	...
	backpack_contents = list(/obj/item/gun/projectile/selfload/moebius = 1, /obj/item/ammo_magazine/pistol/rubber = 2, /obj/item/modular_computer/tablet/moebius/preset = 1, /obj/item/storage/firstaid/adv = 1)
