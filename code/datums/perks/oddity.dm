...
/datum/perk/oddity/parkour
	name = "Parkour"
	desc = "You can climb tables and ladders faster. You can also cling to railings and low walls."
...
/datum/perk/nt_oddity/holy_light
	name = "Holy Light"
	desc = "You have been touched by the divine. You now provide a weak healing aura, healing both brute and burn damage to any Mekhanites nearby as well as yourself."
