...
/obj/item/slime_extract/grey
	...
	icon_state = "grey slime extract"
	description_info = "Inject with phoron to create another slime. Inject with water to create 3 monkey cubes."

/obj/item/slime_extract/gold
	name = "gold slime extract"
	icon_state = "gold slime extract"
	description_info = "Inject with phoron to create 2 roach cubes."

/obj/item/slime_extract/silver
	name = "silver slime extract"
	icon_state = "silver slime extract"
	description_info = "Inject with phoron to create food!"

/obj/item/slime_extract/metal
	name = "metal slime extract"
	icon_state = "metal slime extract"
	description_info = "Inject with phoron to create 15 sheets of metal and 5 of plasteel"

/obj/item/slime_extract/purple
	name = "purple slime extract"
	icon_state = "purple slime extract"
	description_info = "Inject with phoron to create slime steroids. Inject with sugar to create even more slime jelly."

/obj/item/slime_extract/darkpurple
	name = "dark purple slime extract"
	icon_state = "dark purple slime extract"
	description_info = "Inject with phoron to create 10 sheets of phoron. Break the economy!"

/obj/item/slime_extract/orange
	name = "orange slime extract"
	icon_state = "orange slime extract"
	description_info = "Inject with blood to create capsaicin. Inject with phoron to trigger a fiery explosion with a 5 second delay"
	description_antag = "The phoron fire reaction will severely burn anyone stuck in small spaces."

/obj/item/slime_extract/yellow
	name = "yellow slime extract"
	icon_state = "yellow slime extract"
	description_info = "Inject with blood to create a strong EMP pulse. Inject with phoron to create a large powerfull cell. Inject with water to create a long-lasting light-source"


/obj/item/slime_extract/red
	name = "red slime extract"
	icon_state = "red slime extract"
	description_info = "Inject with phoron to create gylcerol at a 1/8 ratio. Inject with blood to turn all nearby slimes rabid"
...
/obj/item/slime_extract/blue
	...
	description_info = "Inject with phoron to create frostoil at a 1/10 ratio."

/obj/item/slime_extract/darkblue
	name = "dark blue slime extract"
	icon_state = "dark blue slime extract"
	description_info = "Inject with phoron to trigger a freeze-reaction with 5 second delay."
...
/obj/item/slime_extract/pink
	...
	description_info = "Inject with phoron to create a slime docility potion."

/obj/item/slime_extract/green
	name = "green slime extract"
	icon_state = "green slime extract"
	description_info = "Inject with phoron to create Slime Mutation Toxin , which can be used to turn yourself into a Slime-Human hybrid"
...
/obj/item/slime_extract/lightpink
	...
	description_info = "Inject with phoron to create a more potent docility potion, useable on adult slimes."

/obj/item/slime_extract/black
	name = "black slime extract"
	icon_state = "black slime extract"
	description_info = "Inject with phoron to create advanced slime mutation toxin"
	description_antag = "Once someone becomes a slime, there is no turning back."

/obj/item/slime_extract/oil
	name = "oil slime extract"
	icon_state = "oil slime extract"
	description_info = "Inject with phoron to trigger a explosive reaction with a 5 second delay."

/obj/item/slime_extract/adamantine
	name = "adamantine slime extract"
	icon_state = "adamantine slime extract"
	description_info = "Inject with phoron to create a golem rune, that can be used to summon a royal servant"
