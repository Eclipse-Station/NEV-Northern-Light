...
/obj/item/parts/heavysniper/barrel
	name = "sniper rifle barrel"
	desc = "This is a barrel from a sniper rifle."
	icon_state = "sniper_barrel"

/obj/item/parts/heavysniper/stock/attackby(obj/item/W, mob/user,)
	if(istype(W,/obj/item/parts/heavysniper/reciever))
		to_chat(user, "You attach the reciever to the stock")
		var/obj/item/parts/heavysniper/stockreciever/HS = new (get_turf(src))
		if(loc == user)
...
/obj/item/parts/heavysniper/stockreciever/attackby(obj/item/W, mob/user)
	if(istype(W,/obj/item/parts/heavysniper/barrel))
