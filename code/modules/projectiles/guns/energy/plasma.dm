...
/obj/item/weapon/gun/energy/plasma/martyr // or should it be  Zealot
	name = "NT PR \"Martyr\""
	desc = "A Mekhanite weapon that uses advanced biomass conversion to create controllable blasts of energized matter. A disposable, single-use side arm, good enough to save you and be recycled."
