...
/datum/ritual/cruciform/priest/epiphany
	...
	desc = "Mekhane's principal sacrament is a ritual of baptism and merging with the Core Implant. A body, relieved of clothes should be placed on a Mekhanite altar."
