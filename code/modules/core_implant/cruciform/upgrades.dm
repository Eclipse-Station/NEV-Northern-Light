...
/obj/item/weapon/cruciform_upgrade
	name = "Base Cruciform Upgrade"
	desc = "Cruciform upgrade, is now part of our reality."
	icon = 'icons/obj/module.dmi'
	icon_state = "core_upgrade"
	bad_type = /obj/item/weapon/cruciform_upgrade
	var/mob/living/carbon/human/wearer
	var/obj/item/weapon/implant/core_implant/cruciform/cruciform
	var/active = FALSE

/obj/item/weapon/cruciform_upgrade/proc/install(var/mob/living/target, var/obj/item/weapon/implant/core_implant/cruciform/_cruciform)
...
/obj/item/weapon/cruciform_upgrade/proc/OnInstall(var/disciple, var/_cruciform)

/obj/item/weapon/cruciform_upgrade/proc/OnUninstall()
...
/obj/item/weapon/cruciform_upgrade/natures_blessing/OnInstall(var/disciple, var/_cruciform)
	..()
	START_PROCESSING(SSobj, src)

/obj/item/weapon/cruciform_upgrade/natures_blessing/OnUninstall()
	..()
	STOP_PROCESSING(SSobj, src)

/obj/item/weapon/cruciform_upgrade/natures_blessing/Process()
...
/obj/item/weapon/cruciform_upgrade/faiths_shield/OnInstall(var/disciple, var/_cruciform)
	..()
	wearer.species.brute_mod -= shield_mod
	wearer.species.burn_mod -= shield_mod

/obj/item/weapon/cruciform_upgrade/faiths_shield/OnUninstall()
	..()
	wearer.species.brute_mod += shield_mod
	wearer.species.burn_mod += shield_mod
...
/obj/item/weapon/cruciform_upgrade/cleansing_presence/OnInstall(var/disciple, var/_cruciform)
	..()
	START_PROCESSING(SSobj, src)

/obj/item/weapon/cruciform_upgrade/cleansing_presence/OnUninstall()
	..()
	STOP_PROCESSING(SSobj, src)

/obj/item/weapon/cruciform_upgrade/cleansing_presence/Process()
	wearer.clean_blood()
...
/obj/item/weapon/cruciform_upgrade/wrath_of_god/OnInstall(var/disciple, var/_cruciform)
	..()
...
/obj/item/weapon/cruciform_upgrade/wrath_of_god/OnUninstall()
	..()
	wearer.damage_multiplier -= damage_mod
	wearer.species.brute_mod -= receive_damage_mod
	wearer.species.burn_mod -= receive_damage_mod
