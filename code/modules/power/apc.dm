...
/obj/machinery/power/apc
	...
	description_antag = "Can be unlocked by pulsing the lock wire. Can also be sabotaged by inserting phoron into its cell, making it blow whenever its turned on" //Eclipse Edit - lore compliance
